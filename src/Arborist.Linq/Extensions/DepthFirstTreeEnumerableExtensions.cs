...
//    {
//      var nodes = new Stack<List<SimpleNode<TValue>>>();

//      nodes.Push(new List<SimpleNode<TValue>>());
...
//              {
//                var node = new SimpleNode<TValue>(tokens.Pop().Node, nodes.Pop());
//                nodes.Peek().Add(node);
//              }
//              else
//              {
//                nodes.Peek().Add(new SimpleNode<TValue>(tokens.Pop().Node));
//                var node = new SimpleNode<TValue>(tokens.Pop().Node, nodes.Pop());
//                nodes.Peek().Add(node);
//              }
//              break;

      ...
      new TreeTestDefinition[]
      {
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>()
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.OriginalPosition.Depth > 0 && visit.OriginalPosition.Depth < 4 ? TraversalStrategy.SkipNode : TraversalStrategy.TraverseSubtree,
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>()
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.OriginalPosition.Depth == 0 || visit.OriginalPosition.Depth == 2 ? TraversalStrategy.SkipNode : TraversalStrategy.TraverseSubtree,
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              ExpectedBreadthFirstResults = new[]
              {
                ...
                (TreenumeratorMode.SchedulingNode, "g", 0, (0, 2), (0, 2)),
                (TreenumeratorMode.VisitingNode,   "d", 2, (2, 1), (2, 1)),
                (TreenumeratorMode.VisitingNode,   "e", 1, (0, 2), (0, 2)),
                (TreenumeratorMode.VisitingNode,   "f", 1, (0, 2), (0, 2)),
                (TreenumeratorMode.VisitingNode,   "g", 1, (0, 2), (0, 2)),
              }.ToNodeVisitArray(),
              ExpectedDepthFirstResults = new[]
              {
                (TreenumeratorMode.SchedulingNode, "a", 0, (0, 0), (0, 0)),
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit =>
                ...
                : visit.OriginalPosition.Depth == 1  
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit =>
                visit.OriginalPosition.Depth == 0
                ? TraversalStrategy.SkipNode
                : visit.OriginalPosition.Depth == 2  
                ? TraversalStrategy.SkipSubtree
                : TraversalStrategy.TraverseSubtree,
              ...
              ExpectedBreadthFirstResults = new[]
              {
                ...
                (TreenumeratorMode.VisitingNode,   "b", 1, (0, 1), (0, 0)),
                (TreenumeratorMode.SchedulingNode, "e", 0, (0, 2), (0, 1)),
                (TreenumeratorMode.VisitingNode,   "c", 1, (1, 1), (1, 0)),
                (TreenumeratorMode.SchedulingNode, "f", 0, (0, 2), (0, 1)),
                (TreenumeratorMode.VisitingNode,   "d", 1, (2, 1), (2, 0)),
                (TreenumeratorMode.SchedulingNode, "g", 0, (0, 2), (0, 1)),
              }.ToNodeVisitArray(),
              ExpectedDepthFirstResults = new[]
              {
                (TreenumeratorMode.SchedulingNode, "a", 0, (0, 0), (0, 0)),
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit =>
                visit.OriginalPosition.Depth == 1
                ? TraversalStrategy.SkipNode
                : visit.OriginalPosition.Depth == 2 && visit.Node != "g"
                ? TraversalStrategy.SkipSubtree
                : TraversalStrategy.TraverseSubtree,
              ...
              ExpectedBreadthFirstResults = new[]
              {
                ...
                (TreenumeratorMode.SchedulingNode, "g", 0, (0, 2), (0, 1)),
                (TreenumeratorMode.VisitingNode,   "a", 2, (0, 0), (0, 0)),
                (TreenumeratorMode.VisitingNode,   "g", 1, (0, 2), (0, 1)),
              }.ToNodeVisitArray(),
              ExpectedDepthFirstResults = new[]
              {
                (TreenumeratorMode.SchedulingNode, "a", 0, (0, 0), (0, 0)),
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              ExpectedBreadthFirstResults = new[]
              {
                ...
                (TreenumeratorMode.VisitingNode,   "b", 1, (0, 1), (0, 1)),
                (TreenumeratorMode.SchedulingNode, "c", 0, (0, 2), (0, 2)),
                (TreenumeratorMode.SchedulingNode, "d", 0, (1, 2), (0, 2)),
              }.ToNodeVisitArray(),
              ExpectedDepthFirstResults = new[]
              {
                (TreenumeratorMode.SchedulingNode, "a", 0, (0, 0), (0, 0)),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.OriginalPosition.Depth == 1 && visit.OriginalPosition.SiblingIndex == 1 ? TraversalStrategy.SkipNode : TraversalStrategy.TraverseSubtree,
              Description = "Skip level 1, sibling 1 node",
              ExpectedBreadthFirstResults = new[]
              {
                (TreenumeratorMode.SchedulingNode, "a", 0, (0, 0), (0, 0)),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "d" ? TraversalStrategy.SkipNode : TraversalStrategy.TraverseSubtree,
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "d" ? TraversalStrategy.SkipSubtree : TraversalStrategy.TraverseSubtree,
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "d" ? TraversalStrategy.SkipDescendants : TraversalStrategy.TraverseSubtree,
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "b" ? TraversalStrategy.SkipDescendants : TraversalStrategy.TraverseSubtree,
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "c" ? TraversalStrategy.SkipDescendants : TraversalStrategy.TraverseSubtree,
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>()
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.OriginalPosition.Depth == 0 ? TraversalStrategy.SkipNode : TraversalStrategy.SkipSubtree,
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "a" ? TraversalStrategy.SkipSubtree : TraversalStrategy.TraverseSubtree,
            ...
            new TestScenario
            {
              TraversalStrategySelector = visit => visit.Node == "a" ? TraversalStrategy.SkipDescendants : TraversalStrategy.TraverseSubtree,

  ...
  public static partial class Treenumerable
  {
    public static ITreenumerable<TNode> RootfixScan<TInner, TNode>(
      ...
      => TreenumerableFactory.Create(
        source,
        breadthFirstTreenumerator => new RootfixScanDepthFirstTreenumerator<TInner, TNode>(breadthFirstTreenumerator, accumulator),
        depthFirstTreenumerator => new RootfixScanDepthFirstTreenumerator<TInner, TNode>(depthFirstTreenumerator, accumulator));
